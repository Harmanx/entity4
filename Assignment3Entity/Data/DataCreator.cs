    ...
    public class DataCreator
    {
        ...
        private void CreateUsers()
        {
            ...
            for (int i = 0; i < userCount; i++)
            {
                ...
                user.Email = Constants.DummyEmails[random.Next(Constants.DummyEmails.Count)];
        ...
        private void CreatePostTypes()
        {
            ...
            for (int i = 0; i < postTypeCount; i++)
            {
                ...
                postType.status = random.Next(11) % 2 == 0 ? Statuses.InActive : Statuses.Inactive;
        ...
        private void CreateBlogTypes()
        {
            ...
            for (int i = 0; i < blogTypeCount; i++)
            {
                ...
                blogtype.status = random.Next(11) % 2 == 0 ? Statuses.InActive : Statuses.Inactive;
